...
import 'package:noor/core/networking/near_mosque_service/models/orsm_response.dart';
import 'package:noor/core/networking/near_mosque_service/models/overpass_response.dart';
...
class MosqueApiService {
  ...
  Future<List<Element>> fetchNearbyMosques(LatLng location, int radius) async {
    final query = ApiConstants.overpassQuery(location, radius);
    const overpassApiUrl = ApiConstants.overpassApiUrl;
  ...
  Future<List<LatLng>> fetchRouteFromOSRM(
    ...
    final osrmApiUrl = ApiConstants.osrmApiUrl(pathParams);
