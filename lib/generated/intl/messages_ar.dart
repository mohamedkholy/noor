...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "ask_again": MessageLookupByLibrary.simpleMessage("أطلب مرة أخرى"),
    "asr": MessageLookupByLibrary.simpleMessage("العصر"),
    "authentic_hadith_collection": MessageLookupByLibrary.simpleMessage(
      "مجموعة الأحاديث الصحيحة",
    ),
    "automatic_location_update": MessageLookupByLibrary.simpleMessage(
      "تحديث الموقع تلقائيا",
    ),
    ...
    "battery_optimization_allow": MessageLookupByLibrary.simpleMessage(
      "السماح",
    ),
    "battery_optimization_message": MessageLookupByLibrary.simpleMessage(
      "يرجى استبعاد التطبيق من تحسينات البطارية لضمان عمل منبهات الصلوات والوضع الصامت بدقة في الخلفية.",
    ),
    "battery_optimization_skip": MessageLookupByLibrary.simpleMessage("تخطي"),
    ...
    "location_permission": MessageLookupByLibrary.simpleMessage(
      "للحصول على موقعك الحالي، يجب قبول إذن الوصول إلى الموقع",
    ),
    "location_permission_settings": MessageLookupByLibrary.simpleMessage(
      "تحتاج إلى السماح بإذن الموقع من الإعدادات",
    ),
    "location_settings": MessageLookupByLibrary.simpleMessage("إعدادات الموقع"),
    "madhab": MessageLookupByLibrary.simpleMessage("المذهب"),
    "madhab_hanafi": MessageLookupByLibrary.simpleMessage("الحنفي"),
    "madhab_shafi": MessageLookupByLibrary.simpleMessage("الشافعي"),
    "maghrib": MessageLookupByLibrary.simpleMessage("المغرب"),
    "maghrib_sunnah": MessageLookupByLibrary.simpleMessage("سنة المغرب"),
    "method_dubai": MessageLookupByLibrary.simpleMessage("دبي"),
    "method_egyptian": MessageLookupByLibrary.simpleMessage("المصري"),
    "method_karachi": MessageLookupByLibrary.simpleMessage(
      "كراتشي (جامعة كراتشي)",
    ),
    "method_kuwait": MessageLookupByLibrary.simpleMessage("الكويت"),
    ...
    "method_north_america": MessageLookupByLibrary.simpleMessage(
      "أمريكا الشمالية (هيئة العلماء)",
    ),
    "method_qatar": MessageLookupByLibrary.simpleMessage("قطر"),
    ...
    "no_nearby_mosques_found": MessageLookupByLibrary.simpleMessage(
