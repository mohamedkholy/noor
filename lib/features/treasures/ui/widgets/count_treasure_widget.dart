...
class _CountTreeWidgetState extends State<CountTreeWidget> {
  late final TreasuresCubit _treasuresCubit = context.read();
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        _treasuresCubit.changeTreasuresCount(1);
      },
      child: DecoratedContainer(
        ...
        child: Column(
          children: [
            ...
            Image.asset(Assets.assetsImagesPngTreasure, width: 60, height: 60),
          ],
        ),
      ),
    );
